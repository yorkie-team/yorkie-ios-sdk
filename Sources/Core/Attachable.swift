...
/**
 * `Attachable` is a protocol for resources that can be attached to a client.
 */
@MainActor
protocol Attachable: Sendable {
    /**
     ...
     */
    func getStatus() -> ResourceStatus

    /**
     * `setActor` sets the actor ID of this resource.
     */
     ...
     */
    func publish(_ event: any DocEvent)
}
