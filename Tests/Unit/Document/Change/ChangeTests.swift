...
class ChangeTests: XCTestCase {
    ...
    func test_can_change_actor() throws {
        ...
        XCTAssertEqual(target.operations[0].executedAt.toTestString, "8:actor-1:0")

        target.setActor("actor-2")

        XCTAssertEqual(target.operations[0].executedAt.toTestString, "8:actor-2:0")
    }
    ...
    func test_can_execute() throws {
        ...
        var presences = [ActorID: StringValueTypeDictionary]()
