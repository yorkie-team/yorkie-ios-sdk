...
class SetOperationTests: XCTestCase {
    ...
    func test_can_execute() throws {
        ...
        objectForTest.set(key: "k-c1", value: c1, executedAt: c1.createdAt)

        let target = SetOperation(key: "k-d2", value: objectForTest,
        ...
        XCTAssertEqual(target.toTestString, "4:actor-1:0.SET")
        XCTAssertEqual(target.effectedCreatedAt, objectForTest.createdAt)
    }
}
